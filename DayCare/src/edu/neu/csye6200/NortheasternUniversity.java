...
public class NortheasternUniversity implements University{
    ...
    public NortheasternUniversity(String name){
        this.name = name;
        this.studentController =null;
        this.teacherController = null;
        this.classRoomController = null;
        this.classRoomGroupController = null;
        this.immunizationController = null;
        this.ratingController = null;
    }
    
    public NortheasternUniversity(String name,JPanel studeJpanel){
        
        this.name = name;
        
        StudentModel studentModel = new StudentModel(STUDENT_CSV);
        StudentView studentView = new StudentView(studeJpanel); //need to add proper input;
